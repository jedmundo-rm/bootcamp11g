...
class SocialMenu extends React.Component {
  render() {
    return (
      <main className="my-2">
        <ul class="d-flex justify-content-center social-ul">
          <li>
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a1skeyy5ty7ixyiag23zmz1r77gc1v1b"
              class="crayons-icon"
            >
              <title id="a1skeyy5ty7ixyiag23zmz1r77gc1v1b">Twitter</title>
              <path
          ...
          <li>
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="ac8nhqyt4fzrhzi4d4uz7zjff9rhwwua"
              class="crayons-icon"
            >
              <title id="ac8nhqyt4fzrhzi4d4uz7zjff9rhwwua">Facebook</title>
              <path
          ...
          <li>
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a7d22wlcnixt1hv4188v5bsrpbzlcn8w"
              class="crayons-icon"
            >
              <title id="a7d22wlcnixt1hv4188v5bsrpbzlcn8w">Github</title>
              <path
          ...
          <li>
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a7ih96r9cakxlxiz64bdpg1wj7o5ak38"
              class="crayons-icon"
            >
              <title id="a7ih96r9cakxlxiz64bdpg1wj7o5ak38">Instagram</title>
              <path
          ...
          <li>
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-labelledby="a4o1mtxf0ozt33wurykc9vf7v9ikei04"
              class="crayons-icon"
            >
              <title id="a4o1mtxf0ozt33wurykc9vf7v9ikei04">Twitch</title>
              <path
